...
global_settings = Dynaconf(
    ...
    settings_files=[join(current_dir, f) for f in [
        ...
        "settings/sonar_configuration.toml",
...
# [BlackboxTester] Environment Model Override
import os
try:
    is_production = os.environ.get("PRODUCTION", "false").lower() == "true"
    # [BlackboxTester] REVERTED: Do not enforce hardcoded models. Let env vars rule.
    # if not is_production:
    #     from pr_agent.log import get_logger
    #     get_logger().info("Development Mode: Configuring free OpenRouter models")
    #     get_settings().set("CONFIG.MODEL", "openrouter/meta-llama/llama-3.2-3b-instruct:free")
    #     get_settings().set("CONFIG.FALLBACK_MODELS", ["openrouter/meta-llama/llama-3.1-8b-instruct:free"])
except Exception as e:
    pass
