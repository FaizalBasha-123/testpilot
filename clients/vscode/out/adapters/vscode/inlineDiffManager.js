...
exports.InlineDiffManager = exports.parseUnifiedDiff = void 0;
...
class InlineDiffManager {
    constructor() {
        ...
        this.phantomDecorations = new Map();
    }
    showInlineDiff(editor, unifiedDiff) {
