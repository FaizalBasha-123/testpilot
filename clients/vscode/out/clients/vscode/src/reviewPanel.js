...
class ReviewPanel {
    ...
    static createOrShow(result, commitSha) {
        ...
        const panel = vscode.window.createWebviewPanel('testpilotReview', `TestPilot Review: ${commitSha.substring(0, 7)}`, column, {
            enableScripts: true,
